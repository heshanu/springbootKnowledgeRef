...
@ControllerAdvice
public class EmployeesNotFoundExceptionHandler extends ResponseEntityExceptionHandler {

    @ExceptionHandler(EmployeesNotFoundException.class)
    public ResponseEntity<ErrorRes> handleEmployeesNotFoundException(EmployeesNotFoundException exception) {
